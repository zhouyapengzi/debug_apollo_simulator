...
AINFO<<"(DMCZP) EnteringMethod: MeasureAnchorPointVelocity";
...
void MeasureBboxCenterVelocity(TrackedObjectPtr new_object,
                               const TrackedObjectConstPtr& old_object,
                               const double& time_diff) {
AINFO<<"(DMCZP) EnteringMethod: MeasureBboxCenterVelocity";
AINFO<<"(DMCZP) EnteringMethod: MeasureBboxCornerVelocity";
