...
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::rear_seatbelt_buckled_is_valid";
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::pass_seatbelt_buckled_is_valid";
  Byte t0(bytes + 1);
...
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::driver_seatbelt_buckled_is_valid";
  Byte t0(bytes + 1);
...
bool Occupancyrpt415::rear_seat_occupied_is_valid(const std::uint8_t* bytes,
                                                  int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::rear_seat_occupied_is_valid";
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::pass_seat_occupied_is_valid";
  Byte t0(bytes + 1);
...
bool Occupancyrpt415::driver_seat_occupied_is_valid(const std::uint8_t* bytes,
                                                    int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::driver_seat_occupied_is_valid";
  Byte t0(bytes + 1);
...
bool Occupancyrpt415::rear_seatbelt_buckled(const std::uint8_t* bytes,
                                            int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::rear_seatbelt_buckled";
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::pass_seatbelt_buckled";
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(5, 1);
...
bool Occupancyrpt415::driver_seatbelt_buckled(const std::uint8_t* bytes,
                                              int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::driver_seatbelt_buckled";
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(3, 1);
...
bool Occupancyrpt415::rear_seat_occupied(const std::uint8_t* bytes,
                                         int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::rear_seat_occupied";
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::pass_seat_occupied";
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(2, 1);
...
bool Occupancyrpt415::driver_seat_occupied(const std::uint8_t* bytes,
                                           int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Occupancyrpt415::driver_seat_occupied";
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(0, 1);
