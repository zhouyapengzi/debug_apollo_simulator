...
AINFO<<"(DMCZP) EnteringMethod: Accel6b::Parse";
...
AINFO<<"(DMCZP) EnteringMethod: Accel6b::lateral_acceleration";
  DCHECK_GE(length, 2);
...
double Accel6b::longitudinal_acceleration(const std::uint8_t *bytes,
                                          const int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Accel6b::longitudinal_acceleration";
  DCHECK_GE(length, 4);
...
double Accel6b::vertical_acceleration(const std::uint8_t *bytes,
                                      const int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Accel6b::vertical_acceleration";
  DCHECK_GE(length, 6);
...
AINFO<<"(DMCZP) EnteringMethod: Accel6b::parse_two_frames";
