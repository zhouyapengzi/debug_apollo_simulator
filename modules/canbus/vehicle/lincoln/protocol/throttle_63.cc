...
AINFO<<"(DMCZP) EnteringMethod: Throttle63::Parse";
...
AINFO<<"(DMCZP) EnteringMethod: Throttle63::pedal_input";
...
AINFO<<"(DMCZP) EnteringMethod: Throttle63::pedal_cmd";
...
double Throttle63::pedal_output(const std::uint8_t *bytes,
                                int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Throttle63::pedal_output";
...
int32_t Throttle63::watchdog_counter_source(const std::uint8_t *bytes,
                                            int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Throttle63::watchdog_counter_source";
  Byte frame(bytes + 6);
...
AINFO<<"(DMCZP) EnteringMethod: Throttle63::is_enabled";
  Byte frame(bytes + 7);
...
bool Throttle63::is_driver_override(const std::uint8_t *bytes,
                                    int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Throttle63::is_driver_override";
AINFO<<"(DMCZP) EnteringMethod: Throttle63::is_driver_activity";
  Byte frame(bytes + 7);
AINFO<<"(DMCZP) EnteringMethod: Throttle63::is_channel_1_fault";
AINFO<<"(DMCZP) EnteringMethod: Throttle63::is_channel_2_fault";
AINFO<<"(DMCZP) EnteringMethod: Throttle63::is_connector_fault";
...
bool Throttle63::is_watchdog_counter_fault(const std::uint8_t *bytes,
                                           int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Throttle63::is_watchdog_counter_fault";
  Byte frame(bytes + 7);
