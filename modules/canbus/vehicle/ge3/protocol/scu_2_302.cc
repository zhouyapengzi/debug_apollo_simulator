...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin07";
  Byte t0(bytes + 7);
...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin06";
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(0, 8);
...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin05";
  Byte t0(bytes + 5);
  int32_t x = t0.get_byte(0, 8);
...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin04";
  Byte t0(bytes + 4);
  int32_t x = t0.get_byte(0, 8);
...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin03";
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(0, 8);
...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin02";
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin01";
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
...
AINFO<<"(DMCZP) EnteringMethod: Scu2302::vin00";
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(0, 8);
