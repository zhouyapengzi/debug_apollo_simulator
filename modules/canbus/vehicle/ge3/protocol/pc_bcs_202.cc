...
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::Pcbcs202";

uint32_t Pcbcs202::GetPeriod() const {
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::GetPeriod";
...
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::UpdateData";
  set_p_pc_brkpedreq(data, pc_brkpedreq_);
  set_p_pc_brkpedenable(data, pc_brkpedenable_);
}

void Pcbcs202::Reset() {
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::Reset";
...
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::set_pc_brkpedreq";
...
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::set_p_pc_brkpedreq";
...
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::set_pc_brkpedenable";
...
AINFO<<"(DMCZP) EnteringMethod: Pcbcs202::set_p_pc_brkpedenable";
