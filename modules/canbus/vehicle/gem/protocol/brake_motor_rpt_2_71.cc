...
AINFO<<"(DMCZP) EnteringMethod: Brakemotorrpt271::Brakemotorrpt271";
const int32_t Brakemotorrpt271::ID = 0x71;

void Brakemotorrpt271::Parse(const std::uint8_t* bytes, int32_t length,
                             ChassisDetail* chassis) const {
AINFO<<"(DMCZP) EnteringMethod: Brakemotorrpt271::Parse";
  chassis->mutable_gem()
...
AINFO<<"(DMCZP) EnteringMethod: Brakemotorrpt271::encoder_temperature";
  Byte t0(bytes + 0);
...
int Brakemotorrpt271::motor_temperature(const std::uint8_t* bytes,
                                        int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Brakemotorrpt271::motor_temperature";
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
double Brakemotorrpt271::angular_speed(const std::uint8_t* bytes,
                                       int32_t length) const {
AINFO<<"(DMCZP) EnteringMethod: Brakemotorrpt271::angular_speed";
  Byte t0(bytes + 4);
  int32_t x = t0.get_byte(0, 8);
