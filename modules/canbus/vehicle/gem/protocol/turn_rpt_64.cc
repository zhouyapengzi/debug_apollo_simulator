...
AINFO<<"(DMCZP) EnteringMethod: Turnrpt64::manual_input";
  Byte t0(bytes + 0);
AINFO<<"(DMCZP) EnteringMethod: Turnrpt64::output_value";
...
AINFO<<"(DMCZP) EnteringMethod: Turnrpt64::commanded_value";
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
