...
bool IsClosed(const double x0, const double y0, const double theta0,
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: IsClosed";
...
bool Obstacle::IsInJunction(const std::string& junction_id) {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::IsInJunction";
  return false;
  }
...
void Obstacle::BuildJunctionFeature() {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::BuildJunctionFeature";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::BuildJunctionFeature";
 }
...
void Obstacle::SetJunctionFeatureWithEnterLane(const std::string& enter_lane_id,
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetJunctionFeatureWithEnterLane";
 }
...
void Obstacle::SetJunctionFeatureWithoutEnterLane(Feature* const feature_ptr) {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetJunctionFeatureWithoutEnterLane";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetJunctionFeatureWithoutEnterLane";
 }
...
void Obstacle::SetStatus(const PerceptionObstacle& perception_obstacle,
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetStatus";
 }

void Obstacle::UpdateStatus(Feature* feature) {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::UpdateStatus";

  // Update motion belief
  if (!kf_motion_tracker_.IsInitialized()) {
    ADEBUG << "Obstacle [" << id_ << "] has not initialized motion tracker.";
    
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::UpdateStatus";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::UpdateStatus";
 }
...
void Obstacle::SetType(const PerceptionObstacle& perception_obstacle,
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetType";
 }
...
void Obstacle::SetTimestamp(const PerceptionObstacle& perception_obstacle,
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetTimestamp";
 }
...
void Obstacle::SetPolygonPoints(const PerceptionObstacle& perception_obstacle,
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetPolygonPoints";
 }
...
void Obstacle::SetPosition(const PerceptionObstacle& perception_obstacle,
  ...
  *feature->mutable_position() = perception_obstacle.position();
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetPosition";
 }
...
void Obstacle::SetVelocity(const PerceptionObstacle& perception_obstacle,
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetVelocity";
 }
...
void Obstacle::AdjustHeadingByLane(Feature* feature) {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::AdjustHeadingByLane";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::AdjustHeadingByLane";
 }
...
void Obstacle::UpdateVelocity(const double theta, double* velocity_x,
  ...
  *speed = std::hypot(*velocity_x, *velocity_y);
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::UpdateVelocity";
 }
...
void Obstacle::SetAcceleration(Feature* feature) {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetAcceleration";
 }
...
void Obstacle::SetTheta(const PerceptionObstacle& perception_obstacle,
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetTheta";
 }
...
void Obstacle::SetLengthWidthHeight(
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetLengthWidthHeight";
 }
...
void Obstacle::SetIsNearJunction(const PerceptionObstacle& perception_obstacle,
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetIsNearJunction";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetIsNearJunction";
 }
...
bool Obstacle::HasJunctionFeatureWithExits() {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::HasJunctionFeatureWithExits";
  return false;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::HasJunctionFeatureWithExits";
 }

void Obstacle::InitKFMotionTracker(const Feature& feature) {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::InitKFMotionTracker";
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::InitKFMotionTracker";
 }

void Obstacle::UpdateKFMotionTracker(const Feature& feature) {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::UpdateKFMotionTracker";
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::UpdateKFMotionTracker";
 }

void Obstacle::InitKFPedestrianTracker(const Feature& feature) {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::InitKFPedestrianTracker";
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::InitKFPedestrianTracker";
 }

void Obstacle::UpdateKFPedestrianTracker(const Feature& feature) {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::UpdateKFPedestrianTracker";
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::UpdateKFPedestrianTracker";
 }
...
void Obstacle::SetCurrentLanes(Feature* feature) {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetCurrentLanes";
  return;
  }
  Lane lane;
  if (feature->has_lane()) {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetCurrentLanes";
 }
...
void Obstacle::SetNearbyLanes(Feature* feature) {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetNearbyLanes";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetNearbyLanes";
 }
...
void Obstacle::BuildLaneGraph() {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::BuildLaneGraph";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::BuildLaneGraph";
 }
...
void Obstacle::SetLaneSequenceStopSign(LaneSequence* lane_sequence_ptr) {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetLaneSequenceStopSign";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetLaneSequenceStopSign";
 }
...
void Obstacle::GetNeighborLaneSegments(
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::GetNeighborLaneSegments";
  return;
  }
  if (is_left) {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::GetNeighborLaneSegments";
 }
...
void Obstacle::BuildLaneGraphFromLeftToRight() {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::BuildLaneGraphFromLeftToRight";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::BuildLaneGraphFromLeftToRight";
 }
...
void Obstacle::SetLanePoints(Feature* feature) {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetLanePoints";
 }
...
void Obstacle::SetLanePoints(const Feature* feature,
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetLanePoints";
  return;
  }
  double heading = feature->velocity_heading();
...
void Obstacle::SetLaneSequencePath(LaneGraph* const lane_graph) {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetLaneSequencePath";
 }
...
void Obstacle::SetNearbyObstacles() {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetNearbyObstacles";
 }
...
void Obstacle::SetMotionStatus() {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetMotionStatus";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetMotionStatus";
 }
...
void Obstacle::SetMotionStatusBySpeed() {
  ...
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::SetMotionStatusBySpeed";
  return;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetMotionStatusBySpeed";
 }
...
void Obstacle::InsertFeatureToHistory(const Feature& feature) {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::InsertFeatureToHistory";
 }
...
bool Obstacle::ReceivedNewerMessage(const double timestamp) const {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::ReceivedNewerMessage";

  if (feature_history_.empty()) {
    
  AINFO<<"(DMCZP) (return) LeaveMethod: Obstacle::ReceivedNewerMessage";
  return false;
  }
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::ReceivedNewerMessage";
 }
...
void Obstacle::DiscardOutdatedHistory() {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::DiscardOutdatedHistory";
 }

void Obstacle::SetRNNStates(const std::vector<Eigen::MatrixXf>& rnn_states) {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::SetRNNStates";

  rnn_states_ = rnn_states;

  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetRNNStates";
 }

void Obstacle::GetRNNStates(std::vector<Eigen::MatrixXf>* rnn_states) {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::GetRNNStates";

  rnn_states->clear();
  rnn_states->insert(rnn_states->end(), rnn_states_.begin(), rnn_states_.end());

  AINFO<<"(DMCZP) LeaveMethod: Obstacle::GetRNNStates";
 }

void Obstacle::InitRNNStates() {
  AINFO<<"(DMCZP) EnteringMethod: Obstacle::InitRNNStates";
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::InitRNNStates";
 }
...
void Obstacle::SetCaution() {
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetCaution";
 }
...
void Obstacle::SetEvaluatorType(
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetEvaluatorType";
 }
...
void Obstacle::SetPredictorType(
  ...
  AINFO<<"(DMCZP) LeaveMethod: Obstacle::SetPredictorType";
 }
