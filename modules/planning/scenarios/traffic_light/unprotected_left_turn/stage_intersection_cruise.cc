...
AINFO<<"(DMCZP) EnteringMethod: TrafficLightUnprotectedLeftTurnStageIntersectionCruise::Process";
...
AINFO<<"(DMCZP) EnteringMethod: TrafficLightUnprotectedLeftTurnStageIntersectionCruise::FinishStage";
